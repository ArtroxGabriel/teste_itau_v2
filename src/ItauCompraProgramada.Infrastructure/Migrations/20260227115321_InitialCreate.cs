        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItensCesta_CestasRecomendacao_BasketId",
                        column: x => x.BasketId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tipo = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TickerSold = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TickerBought = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Custodias_ContasGraficas_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdensCompra_ContasGraficas_MasterAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilhoteCustodyId = table.Column<long>(type: "bigint", nullable: false),
                    Ticker = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Quantidade = table.Column<int>(type: "int", nullable: false),
                    PrecoUnitario = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Distribuicoes_Custodias_FilhoteCustodyId",
                        column: x => x.FilhoteCustodyId,
                        principalTable: "Custodias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Distribuicoes_OrdensCompra_PurchaseOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Custodias_AccountId",
                table: "Custodias",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Distribuicoes_FilhoteCustodyId",
                table: "Distribuicoes",
                column: "FilhoteCustodyId");

            migrationBuilder.CreateIndex(
                name: "IX_Distribuicoes_PurchaseOrderId",
                table: "Distribuicoes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItensCesta_BasketId",
                table: "ItensCesta",
                column: "BasketId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdensCompra_MasterAccountId",
                table: "OrdensCompra",
